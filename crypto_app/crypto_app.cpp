...
void crypto_app::get_pubKey_from_pem(const char* file_name, EVP_PKEY** pubKey)
{
...
void crypto_app::get_privateKey_from_pem(const char* file_name, EVP_PKEY** privateKey)
{
	FILE *pem_pubKey_file;
...
int crypto_app::envelope_seal(EVP_PKEY **pub_key, unsigned char *plaintext, int plaintext_len,
...
int crypto_app::envelope_open(EVP_PKEY *priv_key, unsigned char *ciphertext, int ciphertext_len,
	unsigned char *encrypted_key, int encrypted_key_len, unsigned char *iv,
